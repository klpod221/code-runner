  ...
  definition: {
    ...
    components: {
      ...
      schemas: {
        ...
        Language: {
          type: 'object',
          required: ['name', 'displayName', 'extension', 'version', 'runCommand'],
          properties: {
            id: {
              type: 'string',
              format: 'uuid',
            ...
            compileCommand: {
              type: 'string',
              description: 'The command to compile code in this language (for compiled languages)'
            },
            runCommand: {
              type: 'string',
        ...
        CodeExecution: {
          ...
          properties: {
            ...
            compilationOutput: {
              type: 'string',
              description: 'Output from the compilation step (for compiled languages)'
            },
            executionTime: {
              type: 'integer',
